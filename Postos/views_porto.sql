...
DROP VIEW IF EXISTS [Porto_CCS_20_80_percent];
CREATE VIEW Porto_CCS_20_80_percent
AS
SELECT
	"UID DA TOMADA",
	CIDADE,
...
DROP VIEW IF EXISTS [Porto_TYPE2_0_100_percent];
CREATE VIEW Porto_TYPE2_0_100_percent
AS
SELECT
	"UID DA TOMADA",
	CIDADE,
