...
DROP VIEW IF EXISTS [Leiria_Todos_Os_Postos];
CREATE VIEW Leiria_Todos_Os_Postos
AS
SELECT
	"UID DA TOMADA",
	CIDADE,
...
DROP VIEW IF EXISTS [Leiria_CCS2_20_80_percent];
CREATE VIEW Leiria_CCS2_20_80_percent
AS
SELECT
	"UID DA TOMADA",
	CIDADE,
...
DROP VIEW IF EXISTS [Leiria_TYPE2_7kW_0_100_percent];
CREATE VIEW Leiria_TYPE2_7kW_0_100_percent
AS
SELECT
	"UID DA TOMADA",
	CIDADE,
...
DROP VIEW IF EXISTS [Leiria_TYPE2_22kW_0_100_percent];
CREATE VIEW Leiria_TYPE2_22kW_0_100_percent
AS
SELECT
	"UID DA TOMADA",
	CIDADE,
