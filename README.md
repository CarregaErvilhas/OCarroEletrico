...
Os veículos elétricos (`battery electric vehicles` - BEV) podem recarregar a sua bateria de 3 formas diferentes: pontos de carregamento privados, rede de carregadores públicos e regeneração baseada na desaceleração do veículo.
...
Para aqueles que já têm pré-instalação com ligação ao apartamento ou a condutas para passar cablagem, podem fazer qualquer uma das instalações referidas para [Residências](#resid%C3%AAncias), pois é tudo igual.
